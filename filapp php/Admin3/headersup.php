		...
		<div class="full-width navLateral-body">
			...
			<nav class="full-width">
				<ul class="full-width list-unstyle menu-principal">
					<li class="full-width">
						<a href="homeSup.php" class="full-width">
					...
					<li class="full-width">
                        <a href="listaEmpleado.php" class="full-width">
							<div class="navLateral-body-cl">
					...
					<li class="full-width">
                        <a href="metricas.php" class="full-width">
							<div class="navLateral-body-cl">
					...
					<li class="full-width divider-menu-h"></li>
					<li class="full-width">
                        <a href="listaTurnos.php" class="full-width">
							<div class="navLateral-body-cl">
					...
					<li class="full-width">
                        <a href="opcciones.php" class="full-width">
							<div class="navLateral-body-cl">
								<i class="zmdi zmdi-tv-list"></i>
							</div>
							<div class="navLateral-body-cr">
								OPCIONES DE ATENCION
							</div>
						</a>
					</li>
					<figure class="full-width navLateral-body-tittle-menu">
